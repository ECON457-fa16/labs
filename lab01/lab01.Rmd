...
x % y 	gives remainder when you divide x by y, same as rem(x,y)
...
x += y	adds y to x, then reassigns x to the new value
x -= y	subtracts y from x, then reassigns x to the new value
